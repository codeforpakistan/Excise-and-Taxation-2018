  ...
  <!-- Large Size -->
                ...
                <div class="modal-dialog " role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="largeModalLabel">Receive Vehicle</h4>
                        </div>


                            <!-- Tab panes -->

                                  	 	<form  id="warehousehandover_form" method="post" enctype="multipart/form-data">
						...
						<div class="input-group ">
                                            ...
                                            <div class="form-line">
                                                <input type="text" id="letterno" name="letterno" class="form-control " placeholder="">
                                            </div>
                                        </div>
						</div>
            ...
            <input type="hidden" name="authorisedby" id="authorisedby" value="0">
						...
						<div class="form-group">
                          ...
                          <input type="hidden" name="vechicle_id" id="vechicle_id" >
									 ...
									 class="btn bg-green waves-effect">Receive vehicle</button>
 ...
 <div class="card">
                        ...
                        <div class="body table-responsive">
                          <table id="receivehandoverd" class="display" style="width:100%">
        <thead>
            <tr>
