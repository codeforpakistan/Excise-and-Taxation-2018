                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <!-- Tab panes -->
                                  	 	...
                                  	 	<form  id="receive_form" method="post" enctype="multipart/form-data">
						...
						<div class="input-group ">
                                            ...
                                            <div class="form-line">
                                                <input type="text" id="letterno"
												name="letterno" class="form-control " placeholder="" required>
                                            </div>
                                        </div>
						</div>
            ...
            echo $this->session->userdata('user_rolename'); ?>">
						...
						<div class="form-group">
                          ...
                          <input type="hidden" name="vechicle_id" id="vechicle_id" >
									 ...
									 class="btn bg-green waves-effect">Receive</button>
 ...
 <div class="card">
                        ...
                        <div class="body table-responsive">
                          <table id="receivedatatable" class="display" style="width:100%">
        <thead>
          <tr>
				<th>S.no</th>
                <th>Date</th>
