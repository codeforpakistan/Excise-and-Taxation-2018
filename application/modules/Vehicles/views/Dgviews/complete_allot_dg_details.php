                       ...
                       <div class="container" style="    margin-top: 35px; margin-bottom: -100px;">
                           <div class="row">
                              <div class="border_bottom">
                                 <a href="<?php echo base_url();?>/Vehicles/generate_pdf_main"><span class="icon-name">Download</span> <i class="material-icons">picture_as_pdf</i> </a>
                                  <div class="col-md-6">
      ...
      <div class="panel-body">
	   <div class="col-md-4 col-md-offset-1">
	   	 <div class="row brder_botom">
					 ...
					 $individual = $data->individualallot;
	$department = $data->departmentallot ;
					 ?>
      ...
      <div class="panel-body">
	   <div class="col-md-5 col-md-offset-1">
	   	 <div class="row brder_botom">
					 ...
					 <p  class="text-left lin-height">Chassis No</p>
					 </div>
					 <div class="row brder_botom">
					 ...
					 <div class="row brder_botom" >
					 <p class="text-left padding-5">Assembly</p>
...
<div class="col-md-12">					 
    ...
    margin-right: 0px;" > 
					...
					<div class="container pos-absolute">
						...
						<div class="col-md-5">
						<div class="panel panel-default mgr-top-10">
      <div class="panel-heading"> <h5 class="col-md-offset-1"> Allotment Details</h5></div>
      <div class="panel-body">
	  <?php if($department ==1):?>
	  <div class="col-md-5">
					...
					<h5>Attachment </h5>
						...
						<div class="col-md-6">
						<?php foreach($department_allot as $data):?>
						<p><?php echo $data->departmentname	;?></p>
						<p><?php echo $data->description;?></p>
						<p><?php echo $data->designation;?></p>
						<p><?php echo $data->authorisedby;?></p>
	  ...
	  <div class="col-md-5">
					...
					<h5>Attachment </h5>
						...
						<div class="col-md-6">
						<?php foreach($individual_allot as $data):?>
						<p><?php echo $data->receivername	;?></p>
						<p><?php echo $data->receivercnic;?></p>
	  ...
	  <div class="col-md-5">
					...
					<div class="container pos-absolute">
						...
						<div class="col-md-5">
						<div class="panel panel-default mgr-top-10">
      <div class="panel-heading"> <h5 class="col-md-offset-1"> Handover Details</h5></div>
      <div class="panel-body">
	  
	  <div class="col-md-5">
						  
						    <h5 class="brder_botom">LetterNo</h5>
							
						    <h5 class="brder_botom">Receiver Name</h5>
						  <h5 class="brder_botom">Receiver Cnic</h5>

						  <h5 class="brder_botom">Mobile Number</h5>
						
						  <h5 class="brder_botom">Designation</h5>
						  <h5 class="brder_botom">Description</h5>
						  
					<h5 class="brder_botom">Authorisedby</h5>
					
						</div>
	  
						
						<div class="col-md-6">
						<?php foreach($handover_detail as $data):?>  
						<p class="brder_botom"><?php echo $data->letterno	;?></p>
						
						<p class="brder_botom"><?php echo $data->receivername	;?></p>
					
						<p class="brder_botom"><?php echo $data->receivercnic;?></p>
						
						<p class="brder_botom"><?php echo $data->mobilenumber;?></p>
						
						<p class="brder_botom"><?php echo $data->designation;?></p>
						
						
				<p class="brder_botom"><?php echo $data->description;?></p>
						<p class="brder_botom"><?php echo $data->authorizedby;?></p>
