...
<h3 style="text-align:center;">Fsl Request & Response Report</h3>
  <table style="border-collapse: collapse;width:400px;position:relative;left:20px; top:20px;" border="1">
<tbody>
<tr>
<td >Letter No</td>
<td  style="width:500px;"><?php echo $fsl_report->letterno;?></td>

</tr>
<tr>
<td >Time</td>
<td  style="width:500px;"><?php echo $fsl_report->date;?></td>

</tr>
<tr>
<td >Date</td>
<td  style="width:500px;"><?php echo $fsl_report->time;?></td>

</tr>

<tr>
<td >Description</td>
<td  style="width:500px;"><?php echo $fsl_report->description;?></td>
...
<h3 style="text-align:center;">Fsl Response</h3>
  <table style="border-collapse: collapse;width:400px;position:relative;left:20px; top:20px;" border="1">
<tbody>
<tr>
<td >Letter No</td>
<td  style="width:500px;"><?php echo $fsl_report_checkout->letterno;?></td>

</tr>
<tr>
<td >Time</td>
<td  style="width:500px;"><?php echo $fsl_report_checkout->date;?></td>

</tr>
<tr>
<td >Date</td>
<td  style="width:500px;"><?php echo $fsl_report_checkout->time;?></td>

</tr>

<tr>
<td >Description</td>
<td  style="width:500px;"><?php echo $fsl_report_checkout->description;?></td>
