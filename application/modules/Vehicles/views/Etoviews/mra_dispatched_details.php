      ...
      <div class="panel-body">
	   <div class="col-md-4 col-md-offset-1">
	   	 <div class="row brder_botom">
					...
					<div class="row brder_botom text-left"> <p><?php  if(empty($data->siezeddate)){
						echo " N/A";}else{ echo $data->siezeddate;}?></p></div>
	   ...
	   <div class="col-md-5 col-md-offset-1">
	   	 <div class="row brder_botom">
			  ...
			  <?php foreach($all_vechicle_images as $key=>$img):?>
					...
					style="width:450px;height:490px; margin-right: 0px;" > 
