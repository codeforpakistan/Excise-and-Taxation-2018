                       ...
                       <div class="container" style="    margin-top: 35px; margin-bottom: -100px;">
                           <div class="row">
                              <div class="border_bottom">
                                 <a target="_blank" href="<?php echo base_url();?>Vehicles/generate_pdf_main_mra/<?php
...
<div class="col-md-12">
	  ...
	  <div class="col-md-5">
	<ul id="image-gallery1" class="gallery list-unstyled cS-hidden" style="width:450px;height:490px;
    margin-right: 0px;" >
...
<div class="row ">
<div class="col-md-5 pos-absolute" style="top:220px;">
					<div class="panel panel-default mgr-top-10  " >
	  ...
	  <div class="col-md-5">
                       ...
                       <div class="container  pos-absolute" style="top:240px;">
                        <div class="row">
						<div class="col-md-5  ">
						<div class="panel panel-default mgr-top-10  ">
	  ...
	  <div class="col-md-5">
					...
					<h5>Attachment </h5>
						...
						<div class="col-md-6">
						<?php foreach($mra_checkout as $data):?>
						<p><?php echo $data->letterno;?></p>
						<p><?php echo $data->mradate;?></p>
						<p><?php echo $data->mratime;?></p>
						<p><?php echo $data->Description;?></p>
